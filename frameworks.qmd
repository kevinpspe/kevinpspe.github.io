...
The only difference between the two worlds is the treatment. Thus, any difference in outcomes between the two worlds must be the [causal effect]{.mark} of the treatment.[^frameworks-1]

[^frameworks-1]: Technically, the stable unit treatment value assumption (SUTVA) is required for this to be true.
