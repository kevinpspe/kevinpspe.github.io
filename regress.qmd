...
Regression seems like a natural way to control for confounders $\b x$ in selection on observables:
...
::: small
$\mean{\b x}$ is a vector of the means of each confounder.
:::

The new OLS estimate of $\widehat\tau$ will be a rougly unbiased estimator of the ATE in large enough samples.
